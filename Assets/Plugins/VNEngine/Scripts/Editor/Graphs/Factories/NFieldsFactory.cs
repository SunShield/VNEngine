...
{
    public static class NFieldsFactory
    {
        public static VisualElement CreateControl(FieldInfo fieldInfo, NPortView view, string label = null)
        {
            ...
            if (type == typeof(LayerMask))
            {
                ...
                field.RegisterValueChangedCallback((change) =>
                {
                    ...
                    EditorUtility.SetDirty(view.GraphView.Graph);
                });
        ...
        /// </summary>
        private static VisualElement BuildVal<TField, TType>(NPortView view, FieldInfo fieldInfo, string label) 
        ...
        /// The control will be created and bound to the given NodeView and its associated target node. 
        /// </summary>
        private static VisualElement BuildRef<TField, TType>(NPortView view, FieldInfo fieldInfo, string label) 
            where TField : BaseField<TType>, new() 
            where TType : class
        {
            try
