...
namespace OerGraph.Core.Data.Graph.EditorBased.Elements.Ports
{
    public abstract partial class OerPort<TType>
    {
        ...
        /// </summary>
        public OerGraph Graph { get; private set; }
        ...
        public void InitializeRuntime(OerGraph graph, OerNode ownerNode, IOerPort valueRetrievingPort, OerNode valueRetrievingNode)
        {
            Graph = graph;
            Node = ownerNode;
